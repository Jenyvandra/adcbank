				...
				<?php $download_mobile_app_title = get_field( 'download_mobile_app_title', 'option'); ?>
				 ...
				 ?>
					<div class="m-app">
						...
						<a href="<?php echo $app_store_link; ?>" target="_blank"><img src="<?php bloginfo('template_url'); ?>/assets/images/app-store-footer.png" alt=""></a>
						<?php endif; ?>
						<?php if( $google_play_link ): ?>
						<a href="<?php echo $google_play_link; ?>" target="_blank"><img src="<?php bloginfo('template_url'); ?>/assets/images/google-play-footer.png" alt=""></a>
						<?php endif; ?>
					</div>
				</div>
			</div>
