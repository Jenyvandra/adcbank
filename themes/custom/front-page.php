		...
		<div class="container">
					...
					<div class="bank-service">
						...
						<div class="content">
							...
							<?php $description=get_field('description');
							      echo $description; ?>
							<div class="k-more"><a class="btn" href="<?php echo get_permalink();?>"><?php _e('Know More');?></a></div>
						</div>
					</div>
				</div>
		    	<?php endwhile; ?>
			...
			wp_reset_postdata(); ?>
				...
				<!-- <div class="col-md-6 col-lg-4 mb-4">
					<div class="bank-service">
						<div class="img-wrap">
							<img src="<?php bloginfo('template_url'); ?>/assets/images/jyotirgmay-vima-yojana.png" alt="">
						</div>
						<div class="content">
							<h3>Jyotirgmay Vima Yojana Plus</h3>
							<p>Get better facilities & services from leading Hospitals. Age limit extended to 75 years without medical examination .</p>
							<div class="k-more"><a href="#">Know More</a></div>
						</div>
					</div>
				</div>
				<div class="col-md-6 col-lg-4 mb-4">
					<div class="bank-service">
						<div class="img-wrap">
							<img src="<?php bloginfo('template_url'); ?>/assets/images/LIC-PMJJBY.png" alt="">
						</div>
						<div class="content">
							<h3>LIC - PMJJBY</h3>
				...
				<div class="col-md-6 col-lg-4 mb-4">
					<div class="bank-service">
						<div class="img-wrap">
							<img src="<?php bloginfo('template_url'); ?>/assets/images/rupay-cards.png" alt="">
						</div>
						<div class="content">
							<h3>ATM / Rupay Cards</h3>
							<p>Using RUPAY card our customers can access all ATMs under network for cash withdrawal, balance inquiry,...</p>
							<div class="k-more"><a href="#">Know More</a></div>
						</div>
					</div>
				</div>
				<div class="col-md-6 col-lg-4 mb-4">
					<div class="bank-service">
						<div class="img-wrap">
							<img src="<?php bloginfo('template_url'); ?>/assets/images/internet-mobile-banking.png" alt="">
						</div>
						<div class="content">
							<h3>Internet / Mobile Banking</h3>
							<p>MobileBanking / InternetBanking is the most easy and convenient way to stay connected to your bank.. 24/7!</p>
							<div class="k-more"><a href="#">Know More</a></div>
						</div>
					</div>
				</div>
				<div class="col-md-6 col-lg-4 mb-4">
					<div class="bank-service">
						<div class="img-wrap">
							<img src="<?php bloginfo('template_url'); ?>/assets/images/digital-payment.png" alt="">
						</div>
						<div class="content">
					...
					<?php $rate_and_charges_title = get_field('rate_and_charges_title'); ?>
						...
						<div class="accordion-wrap">
							...
							<?php if( have_rows('rate_and_charges_details') ): ?>
								...
								<!-- <div class="accordion-set">
								  <a href="javascript:void(0);" class="">
									<img src="<?php bloginfo('template_url'); ?>/assets/images/deposit-icon.png" alt="">
									<span>Deposit</span>
								  </a>
								  <div class="accordion-content">
									<p>Fixed Deposits (390 Days)</p>
									<table>
										<tr>
											<td>Regular</td>
											<td>7.20%</td>
								...
								<div class="accordion-set">
									<a href="javascript:void(0);" class="">
									  <img src="<?php bloginfo('template_url'); ?>/assets/images/savings-ac-icon.png" alt="">
								  ...
								  <div class="accordion-set">
									<a href="javascript:void(0);" class="">
									  <img src="<?php bloginfo('template_url'); ?>/assets/images/loans-ac-icon.png" alt="">
									  <span>Loans</span>
									</a>
									<div class="accordion-content" style="display: none;">
									  <p>Fixed Deposits (390 Days)</p>
							...
							<div class="text-center"><a href="#" class="btn"><?php _e('See All Rates') ?></a></div>
						</div>
					</div>
				</div>
			</div>
					...
					<h3><?php echo $stories_in_focus_title; ?></h3>
						...
						if ( $result-> have_posts() ) :?>
							...
							<div class="accordion-set-one">
								...
								<div class="accordion-content-one" style=<?php echo $style; ?>>
								<?php $description=get_field('description');
							      echo $description; ?>	
								</div>
							</div>
						...
						<!-- <div class="accordion-set-one">
							<a href="javascript:void(0);" class="stories">
							  <span>How to Grow Money?</span>
							</a>
							<div class="accordion-content-one">
							  <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text</p>
							</div>
						</div>
						<div class="accordion-set-one">
							<a href="javascript:void(0);" class="stories">
							  <span>A Smart Way To Shop Using Kotak Smart EMI</span>
							</a>
						...
						<div class="accordion-set-one">
							<a href="javascript:void(0);" class="stories">
							  <span>Investing in your child's future?</span>
							</a>
							<div class="accordion-content-one" style="display: none;">
							  <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text</p>
							</div>
						...
						<div class="accordion-set-one">
							<a href="javascript:void(0);" class="stories">
							  <span>Fixed Deposit Vs Savings Account</span>
							</a>
							<div class="accordion-content-one" style="display: none;">
							  <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text</p>
							</div>
						</div>
						<div class="k-more"><a href="#">Read more stories</a></div>
					</div> -->
				</div>
			</div>
			<div class="row mb-5">
			<?php $insights_title=get_field('insights_title');?>
				...
				<div class="col-md-12 col-lg-4 mb-4">
					...
					<h3><?php echo $news_post_title; ?></h3>
						...
						wp_reset_postdata(); ?>
						<!-- <div class="article">
							<p>RBI Kehta Hai.Jaankar Baniye, Satark Rahiye!</p>
							<a href="#" class="r-more">Read more »</a>
						</div>
						<div class="article">
							<p>Financial inclusion week</p>
							<a href="#" class="r-more">Read more »</a>
						</div>
						<div class="article">
							<p>Lic-pradhan mantri jeevan jyoti bima yojana – link your aadhar card to your saving account and gain life insurance of rs. 2 lack</p>
							<a href="#" class="r-more">Read more »</a>
						</div>
						<div class="article">
							<p>A ccidental death, major handicap or loss of limb insurance at rs 12</p>
							<a href="#" class="r-more">Read more »</a>
						</div> -->
					</div>
				</div>
