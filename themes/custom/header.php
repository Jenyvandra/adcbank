...
<!--     <title><?php //echo get_bloginfo(); ?></title> -->
    ...
    <!-- Favicon -->
	<link href="<?php bloginfo('template_url'); ?>/assets/images/adc_small.png" rel="bookmark icon">
	<link href="<?php bloginfo('template_url'); ?>/assets/images/adc_small.png" rel="shortcut icon">
	<link href="<?php bloginfo('template_url'); ?>/assets/images/adc_small.png" rel="icon" type="image/x-icon">
    <!-- Favicon -->
			...
			<div class="wrap">
				<div class="small-screen">
					<div class="mobile-header">
						...
						<div class="notification"><a href="#"><img src="<?php bloginfo('template_url'); ?>/assets/images/notification-icon-white.png" alt="" width="18" height="16"><span class="counter"><?php echo $count_posts = wp_count_posts( 'news' )->publish; ?></span></a></div>
					</div>
...
<!-- 
				<div class="main-menu">
					<ul id="main-menu" class="d-flex">
						<li class='has-dropdown'><a href="#"><img src="<?php bloginfo('template_url'); ?>/assets/images/accounts-nav.png" alt="">ACCOUNTS</a>
						...
						<li class='has-dropdown'><a href="#"><img src="<?php bloginfo('template_url'); ?>/assets/images/loans-nav.png" alt="">LOANS</a>
							<div class="dropdown-menu dropdown-menu-large">
								<div class="two-col-layout">
									<div class="col8">
										<div>
						...
						<li class='has-dropdown'><a href="#"><img src="<?php bloginfo('template_url'); ?>/assets/images/investment-nav.png" alt="">INVESTMENT</a>
							<div class="dropdown-menu dropdown-menu-large">
								<div class="two-col-layout">
									<div class="col8">
										<div>
						...
						<li class='has-dropdown'><a href="#"><img src="<?php bloginfo('template_url'); ?>/assets/images/insurance-nav.png" alt="">INSURANCE</a>
							<div class="dropdown-menu dropdown-menu-large">
								<div class="two-col-layout">
									<div class="col8">
										<div>
						...
						<li class='has-dropdown'><a href="#"><img src="<?php bloginfo('template_url'); ?>/assets/images/d-banking-nav.png" alt="">DIGITAL BANKING</a>
							<div class="dropdown-menu dropdown-menu-large">
								<div class="two-col-layout">
									<div class="col8">
										<div>
						...
						<li><a href="#"><img src="<?php bloginfo('template_url'); ?>/assets/images/offers-nav.png" alt="">OFFERS</a></li>
						<li class='has-dropdown'><a href="#"><img src="<?php bloginfo('template_url'); ?>/assets/images/o-services-nav.png" alt="">OTHER SERVICES</a>
							<div class="dropdown-menu dropdown-menu-large">
								<div class="two-col-layout">
									<div class="col8">
										<div>
						...
						<li class="small-screen"><a href="#">About Us</a></li>
						<li class="small-screen"><a href="#">History</a></li>
						<li class="small-screen"><a href="#">Chairman's Message</a></li>
					</ul>
				</div> -->
			</div>
		</div>
