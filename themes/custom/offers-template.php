			...
			<div class="fil">
				...
				foreach( $tags as $tag ){
				    ?><div class="adc-form-group">
				     	<input type="checkbox" class="adc_tag" id="tag-<?php echo $tag->term_id; ?>" value="<?php echo $tag->slug; ?>" <?php echo ( isset( $_GET['tags'] ) && in_array( $tag->slug, $_GET['tags'] ) ) ? 'checked="checked"' : ''; ?>>
			...
			<div class="adc-brands mb-5">
				...
				foreach( $brands as $brand ){
				    ...
				    ?><div class="adc-form-group adc-brand" <?php echo $i > 3 ? 'style="display:none;"' : ''; ?>>
				    	<input type="checkbox" id="brand-<?php echo $brand->term_id; ?>" value="<?php echo $brand->slug; ?>" class="adc_brand" <?php echo ( isset( $_GET['brands'] ) && in_array( $brand->slug, $_GET['brands'] ) ) ? 'checked="checked"' : ''; ?>>
						...
						?><div class="col-md-6 mb-4">
							<div class="bank-service">
								<div class="content">
									...
									<a class="offers-btn d-block pb-2" href="<?php echo get_permalink($query->ID); ?>"><?php _e('Know More'); ?><i class="fa fa-angle-right"></i></a>
									<hr class="my-4">
